...
CREATE TABLE "profiles" (
    ...
    "accepts_not_911" BOOLEAN NOT NULL DEFAULT false,
    "accepts_privacy" BOOLEAN NOT NULL DEFAULT false,
    "accepts_health_data" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "contacts" (
    ...
    "kyc_status" "KycStatus" NOT NULL DEFAULT 'pending',
    "kyc_completed_at" TIMESTAMP(3),
    "accepts_alerts" BOOLEAN NOT NULL DEFAULT false,
    "accepts_call_911" BOOLEAN NOT NULL DEFAULT false,
    "accepts_privacy" BOOLEAN NOT NULL DEFAULT false,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "contacts_invite_token_key" ON "contacts"("invite_token");
