...
- Contrato y eventos solo con identificadores aleatorios y compromisos generados con clave secreta del servidor; evitar hashes simples de datos predecibles. La bitácora de base de datos es operativa, mientras Stellar aporta una prueba verificable de integridad temporal.
